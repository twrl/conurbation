...
_start:
        ...
        mov [_uefi_image_handle], rcx
        mov [_uefi_system_table_ptr], rdx

        mov rdi, __preinit_array_start
        mov rsi, __preinit_array_end
        ...
        mov rdi, __fini_array_start
        mov rsi, __fini_array_end
        call fun_array_rev
