...
enum class elf64_relocation_type_t : uint32_t {
    rNone,
    r64,
    rPC32,
    rGOT32,
...
struct elf64_rel_t {
    ...
    inline auto type() -> const elf64_relocation_type_t { return (uint32_t)(r_info & 0xFFFFFFFFL); }
    inline auto type(const elf64_relocation_type_t t) -> elf64_rel_t& { r_info = ((uint64_t)symbol() << 32) + (t & 0xFFFFFFFFL); return *this; }
};
