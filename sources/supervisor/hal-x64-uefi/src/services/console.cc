...
#include "conurbation/uefi/simple_text_output.h"
...
namespace Conurbation::Services::Console
{
    ...
    private:
        Conurbation::UEFI::efi_simple_text_output_p* protocol_;
        Conurbation::UEFI::handle_t handle_;
        uintptr_t attribute_ = 0;

    public:
        uefi_simpletextoutput_diag_console_t(Conurbation::UEFI::efi_system_table_t* SystemTable)
...
namespace {
    ...
    [[gnu::constructor(10)]] auto uefi_console_init(
