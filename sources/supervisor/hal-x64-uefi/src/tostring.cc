...
__attribute__((pure)) const char16_t* Conurbation::UEFI::efiStatusToString(status_t status)
{
    switch (status) {
...
__attribute__((pure)) const char16_t* Conurbation::UEFI::efiMemoryTypeToString(memory_type_t type)
{
