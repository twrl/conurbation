...
#include "uefi/abi.h"
#include "uefi/device_path.h"
#include "uefi/simple_text_input.h"
...
namespace UEFI {
    ...
    typedef status_t(efiabi efi_set_variable_f)(
        char16_t* variableName, guid_t* vendorGuid, variable_attributes_t attributes, uintptr_t dataSize, void* data);
    typedef status_t(efiabi efi_set_virtual_address_map_f)(
        uintptr_t memoryMapSize, uintptr_t descriptorSize, uint32_t descriptorVersion, memory_descriptor_t* virtualMap);
    ...
    typedef status_t(efiabi efi_query_capsule_capabilities_f)(
        capsule_header_t** capsuleHeaderArray, uintptr_t capsuleCount, uint64_t* maximumCapsuleSize, reset_type_t* resetType);
    typedef status_t(efiabi efi_query_variable_info_f)(variable_attributes_t attributes, uint64_t* maximumVariableStorageSize,
    ...
    typedef status_t(efiabi efi_exit_f)(handle_t imageHandle, status_t exitStatus, uintptr_t exitDataSize, char16_t* exitData);
    ...
    typedef status_t(efiabi efi_get_memory_map_f)(uintptr_t* memoryMapSize, memory_descriptor_t* memoryMap, uintptr_t* mapKey,
        uintptr_t* descriptorSize, uint32_t* descriptorVersion);
    ...
    typedef status_t(efiabi efi_load_image_f)(bool_t bootPolicy, handle_t parentImageHandle, efi_device_path_p* devicePath,
        void* sourcebuffer, uintptr_t sourceSize, handle_t* imageHandle);
    typedef status_t(efiabi efi_locate_device_path_f)(guid_t* protocol, efi_device_path_p** devicePath, handle_t* device);
    ...
    typedef status_t(efiabi efi_open_protocol_f)(handle_t handle, guid_t* protocol, void** interface, handle_t agentHandle,
        handle_t controllerHandle, uint32_t attributes);
    ...
    // BOOLEAN Recursive)
    typedef status_t(efiabi efi_connect_controller_f)(
        handle_t ControllerHandle, handle_t* driverImageHandle, efi_device_path_p* remainingDevicePath, bool_t recursive);
